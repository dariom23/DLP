...
//	notExpression:expression -> operator:String  expr:expression

public class NotExpression extends AbstractExpression {

	public NotExpression(String operator, Expression expr) {
	...
	public NotExpression(Object operator, Object expr) {
